...
class Room extends Component {
  ...
  sceneSetup = () => {
    ...
    this.renderer.domElement.classList.add("my-renderer");
    this.renderer.domElement.style.width = "100%";
    // if (navigator.userAgent.match(/Mobile/i)) {
    //   this.renderer.domElement.style.width = "25%";
    // } else {
  ...
  render() {
    return (
      <div className="model" id="models">
        <div className="twoColumnContainer">
          <div className="column2">
            <h2>Gaming Room</h2>
            <p>Created a gaming room with Maya by Autodesk, including custom maps for models, and refined the design to ensure high production standards and specification compliance.</p>
          </div>
